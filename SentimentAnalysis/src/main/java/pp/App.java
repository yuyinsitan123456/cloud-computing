...
public class App 
{
   ...
   void train() throws IOException {
    ...
    public static void main( String[] args ) throws FileNotFoundException, IOException{
    	//CouchDbClient dbClient2 = new CouchDbClient("melbourne", true, "http", "127.0.0.1", 5984, "username", "secret");
    	//couchDBconnection();
       ...
       // String file3 = "C:/Users/ChangLong/Desktop/cloud/test.txt";
        ...
        JavaRDD<String> labeledTweet = rdd.map(f);
	...
	/*	System.out.println("totaltweets: "+gt.getTotalTweets());
        ...
        for (int i=0;i<objs.size();i++) {
            ...
            test[i] = obj.get("text").getAsString();
        }*/
