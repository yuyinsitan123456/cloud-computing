...
public class TwitterClient {
    ...
    public TwitterClient(List<String> terms, List<Location> locations, List<String> languages) {
        ...
        */
        String consumerKey = "RB6HrwjrmThC9NUgZ08GqRTCT";
        String consumerSecret = "Ittz7L8U5h4UblfV0WVifV5O12cznh1M27XKRjR8136XSpgOGU";
        String token = "2271474451-FRekqyQtNHlniyvJG3TuIkGkpudv99uktzrWtQU";
        String secret = "Gre6Rq3qmtaRApZmQ1abdfYtx1xqisQpDyI8m8tr7H7mZ";
    ...
    public static void main(String[] args) {
        ...
        List<Location> locations = Arrays.asList(Locations.SYDNEY);
