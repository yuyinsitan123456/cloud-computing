...
<script src="/resources/food/d3.v4.min.js"></script>
<script src="/resources/sentiment/jquery.min.js"></script>
<script>


    var arr = [[1, 2, 3, 4, 4, 5, 6, 7, 8, 9], [1, 2, 0, 4, 4, 5, 6, 7, 8, 9], [1, 2, 3, 4, 4, 5, 6, 7, 8, 9]];
    var foodArea = [];
    ...
    g.append("text")
        .attr("class", "label")
        .attr("x", margin.left + 2 * width / arr[0].length)
        .attr("y", height + 20)
    ...
    g.append("text")
        .attr("class", "label")
        .attr("x", margin.left + 3 * width / arr[0].length)
        .attr("y", height + 20)
        .attr("dx", ".35em") //vertical align middle
        .text(function (d) {
            return "hello";
