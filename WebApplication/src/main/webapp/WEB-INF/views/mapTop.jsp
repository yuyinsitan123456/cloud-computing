...
<head>
    ...
    <script>
        ...
        function initialize() {
            var outerArray = ${jsonArray};

            var mapOptions = {
                zoom: 10,
                center: new google.maps.LatLng(outerArray[0][0][0][0][1], outerArray[0][0][0][0][0]),//initial location
                mapTypeId: 'terrain'
            };
            ...
            for (var m = 0; m < outerArray.length; m++) {
                var coordinates = outerArray[m];
